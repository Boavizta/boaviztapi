server_impact_by_model_description = "# ✔️Server impacts from model name\n" \
                                     ...
                                     "### 👄 Verbose\n" \
                                     "If set at true, show the impacts of each components and the value used for each " \
                                     "attributes \n " \
                                     "### 📋 Model name\n" \
...
server_impact_by_config_description = "# ✔️Server impacts from configuration\n" \
                                      ...
                                      "🔌 Usage impacts are measured based on the electrical consumption. It can be " \
                                      "retrieve with the time and power per workload "
...
cloud_aws_description = "# ✔️AWS instance impacts from instance type and usage \n" \
                        ...
                        "### 🧮 Measure \n" \
                        "🔨 Manufacture impacts are the sum of the pre-registered components impacts\n\n" \
                        "🔌 Usage impacts are measured based on time per workload given by the user (100% of the time " \
                        "at 50% of workload if not given) and the pre-registered power per workload "
