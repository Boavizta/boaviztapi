...
@terminal_router.get("/all", description=all_terminal_categories)
...
@terminal_router.get("/laptop/archetypes", description=all_archetype_user_terminals)
...
@terminal_router.get("/desktop/archetypes", description=all_archetype_user_terminals)
...
@terminal_router.get("/smartphone/archetypes", description=all_archetype_user_terminals)
...
@terminal_router.get("/tablet/archetypes", description=all_archetype_user_terminals)
...
@terminal_router.get("/television/archetypes", description=all_archetype_user_terminals)
...
@terminal_router.get("/box/archetypes", description=all_archetype_user_terminals)
...
@terminal_router.get("/vr_headset/archetypes", description=all_archetype_user_terminals)
...
async def user_terminal_impact(
    ...
    impacts = compute_impacts(
        model=device, selected_criteria=criteria, duration=duration
    )

    if verbose:
        return {
            "impacts": impacts,
            "verbose": verbose_device(
                device, selected_criteria=criteria, duration=duration
            ),
        }
...
def get_all_archetype_name(name: str):
    result = get_device_archetype_lst_with_type(
        os.path.join(data_dir, "archetypes/user_terminal.csv"), name.lower()
    )
    if not result:
        return None
    return result
