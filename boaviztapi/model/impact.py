...
GWPPb = ImpactCriteria(name="gwpb", unit="kg CO2 eq.", method="PEF", description="Climate change - Contribution of biogenic emissions")
GWPPf = ImpactCriteria(name="gwpf", unit="kg CO2 eq.", method="PEF", description="Climate change - Contribution of fossil fuel emissions")
GWPPlu = ImpactCriteria(name="gwplu", unit="kg CO2 eq.", method="PEF", description="Climate change - Contribution of emissions from land use change")
...
CTUh_c = ImpactCriteria(name="ctuh-c", unit="CTUh", method="PEF", description="Human Toxicity - Carcinogenic Effects")
CTUh_nc = ImpactCriteria(name="ctuh-nc", unit="CTUh", method="PEF", description="Human toxicity - non-carcinogenic effects")
