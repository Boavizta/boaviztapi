...
_VRAM_DIE_SURFACE_PER_GB = 15.5  # in mm2
...
class ComponentGPU(Component):
    ...
    def _complete_vram_surface(self):
        ...
        die_area = (self.vram.value * _VRAM_DIE_SURFACE_PER_GB) / self.vram_dies.value
        die_area_min = (self.vram.min * _VRAM_DIE_SURFACE_PER_GB) / self.vram_dies.min
        die_area_max = (self.vram.max * _VRAM_DIE_SURFACE_PER_GB) / self.vram_dies.max
