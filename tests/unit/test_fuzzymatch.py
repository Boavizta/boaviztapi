...
@pytest.mark.parametrize("cpu_name_input, name, manufacturer, code_name, model_range, tdp, cores, total_die_size, total_die_size_source, source", [
    ...
    ("Intel® Xeon™ CPU 3.20GHz", "Intel Xeon 3.2", "Intel", "Irwindale", "Xeon", 135, 1, 169, "io_die_size () + die_size (169 mm²)", "https://www.techpowerup.com/cpu-specs/xeon-3-2.c245"),
    ("Intel(R) Pentium(R) D CPU 3.40GHz", "Intel Pentium D 840", "Intel", "Smithfield", "Pentium D", 130, 2, 206, "io_die_size () + die_size (206 mm²)", "https://www.techpowerup.com/cpu-specs/pentium-d-840.c319"),
