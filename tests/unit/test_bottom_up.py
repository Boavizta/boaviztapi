...
def test_bottom_up_component_membeddedboard(membeddedboard_model):
    assert bottom_up(membeddedboard_model, allocation=Allocation.TOTAL) == \
           {'adp': {'description': 'Use of minerals and fossil ressources',
