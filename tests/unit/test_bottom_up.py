...
def test_bottom_up_component_cpu_complete(complete_cpu_model):
    assert bottom_up_component(complete_cpu_model, allocation=Allocation.TOTAL) == {
        'adp': {'manufacture': 0.041, 'unit': 'kgSbeq', 'use': 'not implemented'},
        'gwp': {'manufacture': 43.4, 'unit': 'kgCO2eq', 'use': 'not implemented'},
        'pe': {'manufacture': 650.0, 'unit': 'MJ', 'use': 'not implemented'}}
...
def test_bottom_up_component_cpu_incomplete(incomplete_cpu_model):
    assert bottom_up_component(incomplete_cpu_model, allocation=Allocation.TOTAL) == {
        'adp': {'manufacture': 0.02, 'unit': 'kgSbeq', 'use': 'not implemented'},
        'gwp': {'manufacture': 19.7, 'unit': 'kgCO2eq', 'use': 'not implemented'},
        'pe': {'manufacture': 297.0, 'unit': 'MJ', 'use': 'not implemented'}}
...
def test_bottom_up_component_ram_complete(complete_ram_model):
    assert bottom_up_component(complete_ram_model, allocation=Allocation.TOTAL) == {
        'adp': {'manufacture': 0.034, 'unit': 'kgSbeq', 'use': 'not implemented'},
        'gwp': {'manufacture': 530.0, 'unit': 'kgCO2eq', 'use': 'not implemented'},
        'pe': {'manufacture': 6700.0, 'unit': 'MJ', 'use': 'not implemented'}}
...
def test_bottom_up_component_ram_incomplete(incomplete_ram_model):
    assert bottom_up_component(incomplete_ram_model, allocation=Allocation.TOTAL) == {
        'adp': {'manufacture': 0.059, 'unit': 'kgSbeq', 'use': 'not implemented'},
        'gwp': {'manufacture': 1400.0, 'unit': 'kgCO2eq', 'use': 'not implemented'},
        'pe': {'manufacture': 18000.0, 'unit': 'MJ', 'use': 'not implemented'}}
