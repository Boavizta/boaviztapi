    ...
    assert res.json() == {
        "impacts": {
            "adp": {
                ...
                "unit": "kgSbeq",
                "use": {"max": 5.235e-06, "min": 4.336e-08, "value": 4e-07},
            },
            "gwp": {
    ...
    assert res.json() == {
        "impacts": {
            "adpe": {
                ...
                "unit": "kg SB eq.",
                "use": {"max": 0.0002327, "min": 2.891e-06, "value": 3e-05},
            }
        },
        "verbose": {
            "adpe_factor": {
...
async def test_tv_archetype_perso():
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as ac:
        res = await ac.get(
            "/v1/terminal/television?verbose=true&criteria=adpe&archetype=tv-perso"
        )
    ...
    assert res.json() == {
        "impacts": {
            "adpe": {
                ...
                "unit": "kg SB eq.",
                "use": {"max": 0.006701, "min": 1.665e-05, "value": 0.0004},
            }
        },
        "verbose": {
            "adpe_factor": {
...
async def test_tv_archetype_perso_duration():
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as ac:
        res = await ac.get(
            "/v1/terminal/television?verbose=true&criteria=gwp&archetype=tv-perso&duration=1"
        )
    ...
    assert res.json() == {
        "impacts": {
            "gwp": {
                ...
                "unit": "kgCO2eq",
                "use": {"max": 0.324, "min": 0.000414, "value": 0.03},
            }
        },
        "verbose": {
            "avg_power": {
