...
async def test_complete_cpu():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                          ...
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 15.9,
                                            'min': 15.9,
                                            'significant_figures': 3,
                                            'value': 15.9},
                                  'unit': 'kgCO2eq',
                          ...
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 247.0,
                                           'min': 247.0,
                                           'significant_figures': 3,
                                           'value': 247.0},
                                 'unit': 'MJ',
...
async def test_complete_cpu_with_low_precision():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  ...
                                  'use': {'max': 0.00424,
                                          ...
                                          'value': 0.000102}},
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 10.0,
                                            'min': 10.0,
                                            'significant_figures': 1,
                                            'value': 10.0},
                                  'unit': 'kgCO2eq',
                                  'use': {'max': 14000.0,
                                          ...
                                          'value': 610.0}},
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 200.0,
                                           'min': 200.0,
                                           'significant_figures': 1,
                                           'value': 200.0},
                                 'unit': 'MJ',
...
async def test_empty_cpu():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  ...
                                  'use': {'max': 0.00424,
                                          ...
                                          'value': 0.000102}},
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 22.7,
                                            'min': 11.1,
                                            'significant_figures': 3,
                                            'value': 21.7},
                                  'unit': 'kgCO2eq',
                                  'use': {'max': 14000.0,
                                          ...
                                          'value': 610.0}},
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 339.0,
                                           'min': 182.0,
                                           'significant_figures': 3,
                                           'value': 325.0},
                                 'unit': 'MJ',
...
async def test_multiple_cpu():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  ...
                                  'use': {'max': 0.0127,
                                          ...
                                          'value': 0.000307}},
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 47.7,
                                            'min': 47.7,
                                            'significant_figures': 3,
                                            'value': 47.7},
                                  'unit': 'kgCO2eq',
                                  'use': {'max': 43000.0,
                                          ...
                                          'value': 1800.0}},
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 741.0,
                                           'min': 741.0,
                                           'significant_figures': 3,
                                           'value': 741.0},
                                 'unit': 'MJ',
...
async def test_incomplete_cpu_verbose():
    ...
    assert res.json() == {'impacts': {'adp': {'description': 'Use of minerals and fossil ressources',
                                              ...
                                              'use': {'max': 0.00424,
                                                      ...
                                                      'value': 0.000102}},
                                      'gwp': {'description': 'Total climate change',
                                              'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 23.0,
                                                        'min': 22.0,
                                                        'significant_figures': 2,
                                                        'value': 22.0},
                                              'unit': 'kgCO2eq',
                                              'use': {'max': 14000.0,
                                                      ...
                                                      'value': 610.0}},
                                      'pe': {'description': 'Consumption of primary energy',
                                             'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 340.0,
                                                       'min': 330.0,
                                                       'significant_figures': 2,
                                                       'value': 330.0},
                                             'unit': 'MJ',
...
async def test_complete_ram():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  ...
                                  'use': {'max': 0.00254,
                                          ...
                                          'value': 6.13e-05}},
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 530.0,
                                            'min': 530.0,
                                            'significant_figures': 2,
                                            'value': 530.0},
                                  'unit': 'kgCO2eq',
                                  'use': {'max': 8600.0,
                                          ...
                                          'value': 360.0}},
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 6700.0,
                                           'min': 6700.0,
                                           'significant_figures': 2,
                                           'value': 6700.0},
                                 'unit': 'MJ',
...
async def test_empty_ram():
 ...
 'gwp': {'description': 'Total climate change',
         ...
         'use': {'max': 720.0,
                 ...
                 'value': 30.0}},
 'pe': {'description': 'Consumption of primary energy',
        'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 27000.0,
                     'min': 100.0,
                     'significant_figures': 2,
                     'value': 1500.0},
        'unit': 'MJ',
