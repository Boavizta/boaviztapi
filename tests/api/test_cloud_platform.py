...
async def test_empty_usage():
    test = CloudPlatformTest(
        CloudPlatformRequest(provider="aws", platform_type="m6g.metal"),
        ADPImpact(
...
async def test_empty_usage_m6gxlarge():
    test = CloudPlatformTest(
        CloudPlatformRequest("aws", "m6g.xlarge"),
        ADPImpact(
...
async def test_empty_usage_with_url_params_a1():
    test = CloudPlatformTest(
        CloudPlatformRequest("aws", "a1.2xlarge", use_url_params=True),
        ADPImpact(
...
async def test_empty_usage_with_url_params_r5ad():
    test = CloudPlatformTest(
        CloudPlatformRequest("aws", "r5ad.12xlarge", use_url_params=True),
        ADPImpact(
...
async def test_empty_usage_e8ads_v5():
    test = CloudPlatformTest(
        CloudPlatformRequest("azure", "e8ads_v5"),
        ADPImpact(
...
async def test_empty_usage_scw_dev1_l():
    test = CloudPlatformTest(
        CloudPlatformRequest("scaleway", "dev1-l"),
        ADPImpact(
