...
async def test_verbose():
    async with AsyncClient(app=app, base_url="http://test") as ac:
        res = await ac.get('/v1/cloud/instance?verbose=true&instance_type=r5ad.12xlarge&provider=aws')
    ...
    assert res.json() == {'impacts': {'adp': {'description': 'Use of minerals and fossil ressources',
                                      ...
                                      'pe': {'description': 'Consumption of primary energy',
                                             ...
                                             'use': {'max': 5808000.0,
                                                     'min': 121.0,
                                                     'value': 100000.0}}},
                          'verbose': {'ASSEMBLY-1': {'duration': {'unit': 'hours', 'value': 35040.0},
                                                     'impacts': {'adp': {'description': 'Use of '
                                                                                        'minerals and '
                                                                                        'fossil '
                                                                                        'ressources',
                                                                         'embedded': {'max': 5.288e-07,
                                                                                      'min': 5.288e-07,
                                                                                      'value': 5.288e-07,
                                                                                      'warnings': ['End '
                                                                                                   'of '
                                      ...
                                      'CASE-1': {'case_type': {'status': 'ARCHETYPE', 'value': 'rack'},
                                                 ...
                                                 'units': {'max': 1,
                                                           ...
                                                           'status': 'ARCHETYPE',
                                                           'value': 1}},
                                      'CPU-1': {'adp_factor': {'max': 2.656e-07,
                                                               'min': 1.32e-08,
                                                               'source': 'ADEME Base IMPACTS ®',
                                                               'status': 'DEFAULT',
                                                               'unit': 'kg Sbeq/kWh',
                                                               'value': 6.42e-08},
                                                'avg_power': {'max': 112.22999999999999,
                                                ...
                                                'core_units': {'max': 32,
                                                               'min': 32,
                                                               'source': 'Completed from name name '
                                                                         'based on '
                                                ...
                                                'die_size': {'max': 213.0,
                                                             'min': 213.0,
                                                             'source': 'Average value of Naples with 32 '
                                                                       'cores',
                                                             'status': 'COMPLETED',
                                                             'unit': 'mm2',
                                                             'value': 213.0},
                                                ...
                                                'model_range': {'max': 'EPYC',
                                                                ...
                                                                'status': 'COMPLETED',
                                                                'value': 'EPYC'},
                                                'name': {'max': 'AMD EPYC 7571',
                                                         'min': 'AMD EPYC 7571',
                                                         'source': 'fuzzy match',
                                                         'status': 'COMPLETED',
                                                         'value': 'AMD EPYC 7571'},
                                                'params': {'source': 'From TDP',
                                                           'status': 'COMPLETED',
                                                           'value': {'a': 101.6958680014875,
                                                ...
                                                'threads': {'max': 64,
                                                            'min': 64,
                                                            'source': 'Completed from name name based '
                                                                      'on '
                                                                      'https://docs.google.com/spreadsheets/d/1DqYgQnEDLQVQm5acMAhLgHLD8xXCG9BIrk-_Nv6jF3k/edit#gid=224728652.',
                                                            'status': 'COMPLETED',
                                                            'value': 64},
                                                ...
                                                'use_time_ratio': {'max': 1.0,
                                                                   ...
                                                                   'unit': '/1',
                                                                   'value': 1.0},
                                                'workloads': {'status': 'COMPLETED',
                                                              'unit': 'workload_rate:W',
                                                              'value': [{'load_percentage': 0,
                                                                         'power_watt': 24.0},
                                                                        {'load_percentage': 10,
                                                                         'power_watt': 64.0},
                                                                        {'load_percentage': 50,
                                                                        ...
                                                                        {'load_percentage': 100,
                                                                         'power_watt': 204.0}]}},
                                      'MOTHERBOARD-1': {'duration': {'unit': 'hours', 'value': 35040.0},
                                                        'impacts': {'adp': {'description': 'Use of '
                                                                                           'minerals '
                                                                                           'and fossil '
                                                                                           'ressources',
                                                                            'embedded': {'max': 0.001384,
                                                                                         'min': 0.001384,
                                                                                         'value': 0.001384,
                                                                                         'warnings': ['End '
                                                                                                      'of '
                                      ...
                                      'POWER_SUPPLY-1': {'duration': {'unit': 'hours', 'value': 35040.0},
                                                         ...
                                                         'units': {'max': 2.0,
                                                                   ...
                                                                   'status': 'ARCHETYPE',
                                                                   'value': 2.0}},
                                      'RAM-1': {'adp_factor': {'max': 2.656e-07,
                                                               'min': 1.32e-08,
                                                               'source': 'ADEME Base IMPACTS ®',
                                                               'status': 'DEFAULT',
                                                               'unit': 'kg Sbeq/kWh',
                                                               'value': 6.42e-08},
                                                'avg_power': {'max': 109.05599999999998,
                                                ...
                                                'impacts': {'adp': {'description': 'Use of minerals and '
                                                            ...
                                                            'pe': {'description': 'Consumption of '
                                                                   ...
                                                                   'use': {'max': 42930000.0,
                                                                           'min': 1192.0,
                                                                           'value': 1000000.0}}},
                                                'params': {'source': '(ram_electrical_factor_per_go : '
                                                                     '0.284) * (ram_capacity: 32.0) ',
                                                           'status': 'COMPLETED',
                                                           'value': {'a': 9.088}},
                                                'pe_factor': {'max': 468.15,
                                                              'min': 0.013,
                                      ...
                                      'SSD-1': {'capacity': {'max': 900.0,
                                                ...
                                                'units': {'max': 4.0,
                                                          ...
                                                          'status': 'ARCHETYPE',
                                                          'value': 4.0}},
                                      'adp_factor': {'max': 2.656e-07,
                                                     'min': 1.32e-08,
                                                     'source': 'ADEME Base IMPACTS ®',
                                                     'status': 'DEFAULT',
                                                     'unit': 'kg Sbeq/kWh',
                                                     'value': 6.42e-08},
                                      'avg_power': {'max': 354.0576,
                                      ...
                                      'other_consumption_ratio': {'max': 0.6,
                                                                  'min': 0.2,
                                                                  'status': 'ARCHETYPE',
                                                                  'unit': 'ratio /1',
                                                                  'value': 0.33},
