...
async def test_empty_usage():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 0.1,
                                               'min': 0.07,
                          ...
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 600.0,
                                               'min': 300.0,
                                               'significant_figures': 1,
                                               'value': 400.0},
                                  'unit': 'kgCO2eq',
                          ...
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 9000.0,
                                              'min': 4000.0,
                                              'significant_figures': 1,
                                              'value': 6000.0},
                                 'unit': 'MJ',
...
async def test_empty_usage_2():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 0.28,
                                               'min': 0.15,
                                               'significant_figures': 2,
                                               'value': 0.099},
                                  'unit': 'kgSbeq',
                                  'use': {'max': 0.00179,
                                          ...
                                          'value': 0.000193}},
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 3400.0,
                                               'min': 1200.0,
                                               'significant_figures': 2,
                                               'value': 990.0},
                                  'unit': 'kgCO2eq',
                                  'use': {'max': 6100.0,
                                          ...
                                          'value': 1100.0}},
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 44000.0,
                                              'min': 15000.0,
                                              'significant_figures': 2,
                                              'value': 13000.0},
                                 'unit': 'MJ',
...
async def test_usage_1():
    ...
    assert res.json() == {'adp': {'description': 'Use of minerals and fossil ressources',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 0.17,
                                               'min': 0.086,
                                               'significant_figures': 2,
                                               'value': 0.12},
                                  'unit': 'kgSbeq',
                                  'use': {'max': 0.000679,
                                          ...
                                          'value': 0.000149}},
                          'gwp': {'description': 'Total climate change',
                                  'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 1200.0,
                                               'min': 470.0,
                                               'significant_figures': 2,
                                               'value': 790.0},
                                  'unit': 'kgCO2eq',
                                  'use': {'max': 2300.0,
                                          ...
                                          'value': 880.0}},
                          'pe': {'description': 'Consumption of primary energy',
                                 'embedded': {'warnings': ['End of life is not included in the calculation'],'max': 16000.0,
                                              'min': 6300.0,
                                              'significant_figures': 2,
                                              'value': 11000.0},
                                 'unit': 'MJ',
