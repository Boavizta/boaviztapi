    ...
    if type :
        ...
        for i in IMPACT_CRITERIAS:
            try:
                ...
                pass
        str += "\n### Usage\n"
        str = str + f"\n#### Pro\n\n| Name                         | Unit                         | Default values (default;min;max) | Description                                  | Example |\n|------------------------------|------------------------------|---------------------------------|----------------------------------------------|---------|\n| years_life_time              | None                         |                                 | Lifespan of the element                      | {d_pro.usage.life_time.value};{d_pro.usage.life_time.min};{d_pro.usage.life_time.max}       |\n| hours_electrical_consumption | Watt/hour                    |            {d_pro.usage.avg_power.value};{d_pro.usage.avg_power.min};{d_pro.usage.avg_power.max}                    | Average electrical consumption per hour      | 1     |"
        str = str + f"\n\n#### Perso\n\n| Name                         | Unit                         | Default values (default;min;max) | Description                                  | Example |\n|------------------------------|------------------------------|---------------------------------|----------------------------------------------|---------|\n| years_life_time              | None                         |                                 | Lifespan of the element                      | {d_perso.usage.life_time.value};{d_perso.usage.life_time.min};{d_perso.usage.life_time.max}       |\n| hours_electrical_consumption | Watt/hour                    |            {d_perso.usage.avg_power.value};{d_perso.usage.avg_power.min};{d_perso.usage.avg_power.max}                    | Average electrical consumption per hour      | 1     |"
    else:
        str = str + f"## {d_perso.NAME.lower()}\n\n### Embedded impacts\n\n| Criteria | Unit | value |\n|----------|------|------|\n"
