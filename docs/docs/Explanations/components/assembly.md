...
The assembly embedded impacts are considered as a constant.

| Constant                                           | Unit    | Value    |
|----------------------------------------------------|---------|----------|
| $\text{assembly}_{\text{embedded}}^{\text{gwp}}$   | kgCO2eq | 6.68     |
| $\text{assembly}_{\text{embedded}}^{\text{adp}}$   | kgSbeq  | 1.41E-06 |
| $\text{assembly}_{\text{embedded}}^{\text{pe}}$    | MJ      | 68.60    |